...
document
  ...
  .addEventListener("click", function () {
    ...
    if (typeof inputValue === "number" && inputValue > 0) {
      ...
      div.innerHTML = ` ${updateAmount} Taka is Donated at Noakhali, Bangladesh.
            <br>
            <p>${now}</p>
        `;
...
document.getElementById("feniHandle").addEventListener("click", function () {
  ...
  if (typeof inputValue === "number" && inputValue > 0) {
    ...
    div.classList.add("p-4");
    div.classList.add("mt-4");
    div.innerHTML = ` ${updateAmount} Taka is Donated at Feni, Bangladesh.
               <br>
               <p>${now}</p>
         `;
    const historyDiv = AddedHistory("hidtory");
...
document
  ...
  .addEventListener("click", function () {
    ...
    if (typeof inputValue === "number" && inputValue > 0) {
      ...
      div.classList.add("p-4");
      div.classList.add("mt-4");
      div.innerHTML = `  ${updateAmount} Taka is Donated for Aid for Injured in the Quota Movement, Bangladesh. 
            <br>
            <p>${now}</p>
         `;
      const historyDiv = AddedHistory("hidtory");
